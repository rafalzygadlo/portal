...
class Booking extends Component
{
    ...
    {
        $this->company = Company::where('subdomain', $subdomain)->firstOrFail();
    ...
    public function book()
    {
        ...
        $this->resetExcept('company', 'services');
    }

    public function render()
    {
        return view('livewire.company.booking')->layout('layouts.company', ['company' => $this->company]);
    }
}