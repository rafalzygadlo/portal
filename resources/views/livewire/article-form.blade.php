                ...
                <div class="card-body p-4">
                    <form wire:submit.prevent="save">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" wire:model="title" placeholder="Np. Wydarzenie na rynku w Bolesławcu">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" id="content" rows="10" wire:model="content" placeholder="Opisz szczegóły..."></textarea>
