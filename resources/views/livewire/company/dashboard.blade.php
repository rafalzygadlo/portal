<div class="company-dashboard container py-4">
    <div class="mb-4">
    ...
    <ul class="nav nav-tabs mb-4">
        <li class="nav-item">
            <a href="{{ route('dashboard.company', ['company' => $company, 'tab' => 'services']) }}" class="nav-link {{ $tab === 'services' ? 'active' : '' }}">
                Services
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('dashboard.company', ['company' => $company, 'tab' => 'reservations']) }}" class="nav-link {{ $tab === 'reservations' ? 'active' : '' }}">
                Reservations
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('admin.company.resources', $company) }}" class="nav-link">
                Resources
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('dashboard.company', ['company' => $company, 'tab' => 'settings']) }}" class="nav-link {{ $tab === 'settings' ? 'active' : '' }}">
                Settings
            </a>
        </li>
    </ul>
    ...
    @if ($tab === 'settings')
        <div class="card shadow">
            <div class="card-body">
                <h2 class="h4 fw-bold mb-4">Company settings</h2>
                <p class="text-muted">Company hours and other settings will be available here.</p>
            </div>
        </div>
    @endif
