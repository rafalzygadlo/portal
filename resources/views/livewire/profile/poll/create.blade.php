        ...
        <div class="col-lg-6 offset-lg-3">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <h5 class="mb-0"><i class="bi bi-plus-lg me-2"></i> Create Poll</h5>
                </div>
                <div class="card-body p-4">
                    <form wire:submit.prevent="createPoll">
                        <div class="mb-3">
                            <label for="question" class="form-label fw-semibold">Question</label>
                            <input type="text" class="form-control @error('question') is-invalid @enderror" id="question" wire:model.defer="question" placeholder="Ask a question...">
                        ...
                        <div class="mb-3">
                            ...
                            @foreach ($options as $index => $option)
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control @error('options.' . $index) is-invalid @enderror" wire:model.defer="options.{{ $index }}" placeholder="Option {{ $index + 1 }}">
