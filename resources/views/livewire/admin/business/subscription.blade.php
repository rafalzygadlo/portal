<div class="col py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Choose a plan that fits your business and booking needs.</p>
        </div>
        <a href="{{ route('admin.business.dashboard', ['business' => $business]) }}" class="btn btn-sm btn-outline-secondary rounded-pill">
            Back to dashboard
        </a>
    </div>
