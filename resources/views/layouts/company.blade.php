...
<head>
    ...
    <title>{{ $company->name }} - Rezerwacje online</title>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light border-bottom">
        <div class="container-fluid px-4 px-lg-5">
            <a class="navbar-brand fw-bold"
                href="{{ route('company.domain', ['company' => $company]) }}">
                {{ $company->name }}
            </a>
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        <a href="{{ route('login.subdomain', ['company' => $company]) }}"
...
>
    ...
    <footer class="py-4 bg-light mt-5">
        <div class="container text-center">
            <p class="text-muted small">&copy; {{ date('Y') }} {{ $company->name }}. Zasilane przez Twój System
                Rezerwacji.</p>
        </div>
    </footer>
