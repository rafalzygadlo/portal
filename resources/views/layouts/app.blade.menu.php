                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            <a class="dropdown-item" href="{{ route('companies.index') }}"><i class="bi bi-buildings me-2 text-success"></i> Zakłady i Fabryki</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-6 col-lg-2 offset-lg-2">
                        ...
                        <ul class="list-unstyled small">
                            <li class="mb-2"><a href="{{ route('companies.index') }}" class="text-secondary text-decoration-none">Firmy</a></li>
