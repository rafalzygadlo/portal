...
class LoginRedirectTest extends TestCase
{
     ...
     */
    public function test_user_is_redirected_to_the_homepage_after_logging_in_without_an_intended_url(): void
    {
     ...
     */
    public function test_user_is_redirected_to_the_intended_url_after_logging_in(): void
    {
        // 1. Arrange: Create a user
        $user = User::factory()->create([
            'password' => bcrypt('password123'),
